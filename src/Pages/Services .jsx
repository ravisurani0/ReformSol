                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="service-card-2">
                                    ...
                                    <div class="service-card-content">
                                        ...
                                        <a class="default-button-3 default-button-3-h" href="service-details.html">Read More <i
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="service-card-2">
                                    ...
                                    <div class="service-card-content">
                                        ...
                                        <h4><a href="service-details.html">Smart Notification</a></h4>
                                        <p>Lorem ipsum dolor amet magna set dolor sit amet consectetur adipis cing do elite
                                            labore magna aliqua dolor ipsum insididunt aliqua.</p>
                                        <a class="default-button-3 default-button-3-h" href="service-details.html">Read More <i
                                            class="fas fa-long-arrow-alt-right"></i></a>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="service-card-2">
                                    ...
                                    <div class="service-card-content">
                                        ...
                                        <h4><a href="service-details.html">Unlimited Customization</a></h4>
                                        <p>Lorem ipsum dolor amet magna set dolor sit amet consectetur adipis cing do elite
                                            labore magna aliqua dolor ipsum insididunt aliqua.</p>
                                        <a class="default-button-3 default-button-3-h" href="service-details.html">Read More <i
                                            class="fas fa-long-arrow-alt-right"></i></a>
